...
},{"./guided-decision-graph":4,"./parse-grammar":5,"./recognizer.js":6}],4:[function(require,module,exports){
...
},{"./utils/clone.js":8}],5:[function(require,module,exports){
...
},{"./assert-no-self-loops.js":1,"./decision-graph.js":2,"./reduce-grammar.js":7}],6:[function(require,module,exports){
...
},{"./guided-decision-graph.js":4}],7:[function(require,module,exports){
var clone = require('./utils/clone.js')
...
},{"./utils/clone.js":8}],8:[function(require,module,exports){
/**
...
var grammar = {
    Session: ['Sentence , mind_reading , mind_reading , lost_performative , SentencePreposition , mind_reading , Sentence'],
    SentencePreposition: ['PP VerbPhrase NounPhrase PrepositonPhrase'],
    Sentence: ['PP VerbPhrase NounPhrase'],
    /*SentenceDeclarative: ['NounPhrase VerbPhrase'],
    SentenceImperative: ['VerbPhrase'],*/
    PP: ['Du'],
    NounPhrase: ['das AdjN NounN', 'die AdjF NounF', 'den AdjM NounM'],
    NounN: ['Gelingen', 'Glück', 'Schöne', 'Tolle', 'Verzaubernde'],
    NounM: ['Durchbruch', 'Vorteil', 'Gewinn', 'Erfolg', 'Nutzen', 'Überschuss', 'Zufall'],
    NounF: ['Frucht', 'Freude', 'Gelassenheit', 'Leichtigkeit', 'Sanftheit', 'Schwere', 'Verbesserung'],
    AdjN: ['heitere', 'angenehme', 'wunderbare', 'malerische', 'verlockende', 'wundervolle', 'schöne', 'sanfte', 'leichte'],
    AdjF: ['heitere', 'angenehme', 'wunderbare', 'malerische', 'verlockende', 'wundervolle', 'schöne', 'sanfte', 'leichte'],
    AdjM: ['heiteren', 'angenehmen', 'wunderbaren', 'malerischen', 'verlockenden', 'wundervollen', 'schönen', 'sanften', 'leichten'],
    VerbPhrase: ['VerbSense', 'VerbDo'],
    VerbSense: ['fühlst',
        'empfindest',
        'bemerkst',
        'erkennst',
    ...
    VerbDo: ['atmest ein und aus'],
    PrepositonPhrase: [' , PrepositionSame PP NounPhrase VerbPhrase ',
        ' , PrepositionConn VerbPhrase Du NounPhrase',
        ' , PrepositionConnPPBeforeVerb Du NounPhrase VerbPhrase'],
    PrepositionSame: ['während', 'derweil', 'solange', 'da', 'indem', 'einstweilen'],
    /*PrepositionConn: ['während', 'bevor', 'gleich', 'bald', 'nachdem', 'in einer Weile', 'derweil', 'solange', 'da', 'indem', 'einstweilen'],*/
    PrepositionConn: ['gleich', 'bald', 'in einer Weile', 'derweil', 'solange', 'da', 'einstweilen'],
    PrepositionConnPPBeforeVerb: ['während', 'bevor', 'nachdem', 'indem'],
    mind_reading: [
        'eine Enttäuschung im Leben',
        'wichtiges Ziel',
        'das dir am Herzen liegt',
        'noch nicht erreicht',
        'schwer zu vergessen',
        'vielleicht bist du neugierig',
        'wer und wie du in einiger Zeit sein wirst',
        'immer wieder eine schöne Seite',
        'Erfolg der überrascht',
        'du fragst dich',
        'ob es möglich ist',
        'mehr davon zu haben',
        'manches war mühsam',
        'du denkst darüber nach',
        'es dir leichter und einfacher zu machen',
    ],
    lost_performative: ['die meisten Menschen wissen das',
    'die Wissenschaft sagt das',
    'wissenschaftliche Versuche haben das gezeigt',
    'die meisten meiner Klienten fühlen das dabei',
    'das ist gut und hilfreich zu wissen',
    'das ist nicht wichtig',
    'Menschen lernen das gut'],
    universal_quantifier: [
        'alle', 'jeder', 'niemand', 'keiner',
    ],
    universal_quantifier_time: [
        'immer', 'nie'
    ]
};
...
function createText() {
    var guide = graph.createGuide('Session');
    while (guide.isComplete() === false || guide.construction().length < minWords) {
        // var choice = _.sample(guide.choices());
        var choice = guide.choices()[Math.floor(Math.random()*guide.choices().length)];
        guide.choose(choice);
    }
    return guide.construction().join(' ').replace(/\s+/g, ' ').replace(/ ([,.])/g, '$1');
}

module.exports = createText;

},{"grammar-graph":3}],10:[function(require,module,exports){
var createText = require('hypnomodel');
var $ = require('jquery');
...
},{"hypnomodel":9,"jquery":11}],11:[function(require,module,exports){
/*!
